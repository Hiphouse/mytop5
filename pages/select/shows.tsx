...
export default function MoviesSelect(props: any) {
    ...
    useEffect(() => {
        ...
        const url: string = `https://api.themoviedb.org/3/tv/top_rated?api_key=${API_KEY}&language=en-US&page=1`
    ...
    useEffect(() => {
        ...
        const url = `https://api.themoviedb.org/3/search/tv?api_key=${API_KEY}&language=en-US&page=1&query=${formInputData}&include_adult=false`
    ...
    <div>
        <h1>TV Shows</h1>
        {selectedMovies.length ? <h2>Selected Shows</h2> : null }
